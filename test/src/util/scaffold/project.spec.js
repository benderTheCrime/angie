...
describe('$$createProject', function() {
    ...
    it('test successful project creation with directory', function(cb) {
        project({
            ...
            expect(
                fs.mkdirSync.calls[ 2 ].args[ 0 ]
            ).to.eq('test/src/constants');
    ...
    it('test successful project creation with directory false confirm',
        function(cb) {
            ...
            project({
                ...
                expect(
                    fs.mkdirSync.calls[ 3 ].args[ 0 ]
                ).to.eq('test/src/configs');
                expect(fs.writeFileSync.calls[ 1 ].args).to.deep.eq([
                    `test/src/configs/.keep`, 'Keep this directory'
                ]);
                expect(
